...
def afficher_menu():
    with st.sidebar:
        selectionne = option_menu(
            menu_title="Menu",
            options=[
                "Analyse des documents par lot et indice",  # Onglet 1
                "Nombre d'indices par type de document",     # Onglet 2
                "Durée entre versions de documents",         # Onglet 3
                "Évolution des types de documents",          # Onglet 4
                "Flux des documents",                        # Onglet 5
                "Identification des acteurs principaux",     # Onglet 6
                "Analyse de la masse de documents par projet", # Onglet 7
                "Calendrier des Projets",                    # Onglet 8
                "Calendrier par Lot"                         # Onglet 9
            ],
            icons=[
                "bar-chart", "file-text", "clock", "line-chart", 
                "exchange", "users", "chart-bar", "calendar", "calendar"
            ],
            menu_icon="cast",
            default_index=0,
