...
def afficher_menu():
    options = ["Flux des documents", "Évolution des types de documents", "Analyse des documents par lot et indice", 
               "Identification des acteurs principaux", "Analyse de la masse de documents par projet", 
               "Nombre d'indices par type de document", "Durée entre versions de documents", 
               "Calendrier des Projets", "Calendrier par Lot"]
    selectionne = st.sidebar.selectbox("Menu", options)
    return selectionne
