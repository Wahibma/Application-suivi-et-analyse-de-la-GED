...
def afficher_menu():
    with st.sidebar:
        selectionne = option_menu(
            menu_title="Menu",
            options=["Répartition des Catégories de documents", "Nombre de versions des Types de documents", "Durée entre versions de documents", "Évolution des types de documents", "Analyse de la masse de documents", "Flux des documents", "Identification des acteurs principaux", "Analyse des documents par lot et indice", "Calendrier des Projets", "Calendrier par Lot"],
            icons=["pie-chart", "file-text", "clock", "line-chart", "chart-bar", "exchange", "users", "bar-chart", "calendar", "calendar"],
            menu_icon="cast",
            default_index=0,
...
def afficher_graphique(selectionne, donnees, projets, projet_selectionne):
    ...
    # Onglet 7: Identification des acteurs principaux
    ...
    # Onglet 8: Analyse des documents par lot et indice
